...
1. Either [open](https://github.com/elysiumstation/blackfury/issues/new/choose)
   or [find](https://github.com/elysiumstation/blackfury/issues) an issue you have identified and would like to contribute to
   resolving.
...
Check out our [good first issues](https://github.com/elysiumstation/blackfury/issues?q=label%3A%22good+first+issue%22).

## <span id="adr">Architecture Decision Records (ADR)</span>

When proposing an architecture decision for Blackfury,
please create an [ADR](https://github.com/elysiumstation/blackfury/blob/main/docs/architecture/README.md)
...
While my fork lives at `https://github.com/elysiumstation/blackfury`,
the code should never exist at `$GOPATH/src/github.com/elysiumstation/blackfury`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,`$GOPATH/src/github.com/elysiumstation/blackfury`,
...
2. Go to the original repo checked out locally. (i.e. `$GOPATH/src/github.com/elysiumstation/blackfury`)
...
4. Create your feature branch from `development` either on `github.com/elysiumstation/blackfury`, or your fork (
