...
// NewBlackfuryCoin is a utility function that returns an "afury" coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewBlackfuryCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoBlackfury, amount)
}

// NewBlackfuryDecCoin is a utility function that returns an "afury" decimal coin with the given sdkmath.Int amount.
// The function will panic if the provided amount is negative.
func NewBlackfuryDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoBlackfury, amount)
}

// NewBlackfuryCoinInt64 is a utility function that returns an "afury" coin with the given int64 amount.
// The function will panic if the provided amount is negative.
