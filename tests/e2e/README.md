...
```log
ok  	github.com/elysiumstation/blackfury/v9/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/elysiumstation/blackfury/v10/cmd/blackfuryd/root.go:243 +0x2ca
        ...
        main.main()
            github.com/elysiumstation/blackfury/v10/cmd/blackfuryd/main.go:20 +0x45
